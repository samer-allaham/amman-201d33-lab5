...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let sumAllThreeNum = sum(sum(a,b)[0],c)[0];
  let multiplyAllThreeNum = multiply(multiply(a,b)[0],c)[0];

  return [sumAllThreeNum,multiplyAllThreeNum,`${a} and ${b} and ${c} sum to ${sumAllThreeNum}.`,`The product of ${a} and ${b} and ${c} is ${multiplyAllThreeNum}.`]
...
function multiplyArray(multArr) { //eslint-disable-line
  let productMultiplyArray = multArr[0];
  for (let i = 1; i < multArr.length ; i++) {
    productMultiplyArray = multiply(productMultiplyArray,multArr[i])[0];
  }
  return [productMultiplyArray , `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${productMultiplyArray}.`];
}
